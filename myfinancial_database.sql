...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 26 Nov 2024 pada 14.50
...
(2, 'Februari', 2025, 'Makan', 4000000.00),
(2, 'Februari', 2025, 'Air', 100000.00),
(2, 'Februari', 2025, 'Listrik', 300000.00),
(2, 'Februari', 2025, 'Transportasi', 1000000.00),
(2, 'Februari', 2025, 'Nabung', 5000000.00),
(2, 'Februari', 2025, 'Belanja', 5000000.00),
(2, 'Februari', 2025, 'Hiburan', 4000000.00),
(2, 'Februari', 2025, 'Ngasih ortu', 5000000.00),
(1, 'Februari', 2025, 'Makan', 1200000.00),
(1, 'Februari', 2025, 'Listrik', 300000.00),
(1, 'Februari', 2025, 'Air', 150000.00),
(1, 'Februari', 2025, 'Nabung', 5000000.00),
(1, 'Maret', 2025, 'Makan', 5000000.00),
(1, 'Maret', 2025, 'Listrik', 1000000.00),
(1, 'Maret', 2025, 'Air', 500000.00),
(1, 'Maret', 2025, 'Transportasi', 500000.00);
...
(49, 1, '2024-11-22', 1000000.00, 'Gaji Sampingan', ''),
(50, 1, '2024-11-26', 1000000.00, 'Sampingan', 'Gaji Sampingan'),
(51, 3, '2024-11-26', 2000000.00, 'Dikasih Ortu', ''),
(52, 1, '2024-11-26', 500000.00, 'Dikasih', ''),
(53, 1, '2024-11-26', 600000.00, 'Doorprize', ''),
(54, 3, '2024-11-26', 10000.00, 'Temen Bayar Hutang', '');
...
(52, 1, '2024-11-26', 500000.00, 'Blender', ''),
(53, 1, '2024-11-26', 100000.00, 'Makan', 'Untuk 1 hari');
...
--
ALTER TABLE `id_budget`
  MODIFY `id_budget` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT untuk tabel `pendapatan`
--
ALTER TABLE `pendapatan`
  MODIFY `id_pendapatan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=55;
